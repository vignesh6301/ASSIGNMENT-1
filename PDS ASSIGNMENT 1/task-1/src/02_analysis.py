...
def analysis():
    df = pd.read_csv('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-1/data_clean/clean_data.csv')
    ...
    plt.grid(True)
    plt.show()
    plt.savefig('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-1/result/frailty_based_on_age_and_grip_strength.png', format='png', dpi=300)
