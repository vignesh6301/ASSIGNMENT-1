...
def cleanup():
    df = pd.read_csv('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-2/data_raw/StudentsPerformance.csv')
    math_grade = []
    reading_grade = []
    writing_grade = []
    ...
    df.to_csv('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-2/data_clean/clean_data.csv')
