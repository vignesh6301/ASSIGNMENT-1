...
def graph2(df):
    ...
    plt.tight_layout()
    plt.savefig('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-2/result/grades_based_on_genders.png', format='png', dpi=300)
...
def graph3(df):
    ...
    plt.tight_layout()
    plt.savefig('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-2/result/grades_based_on_parental_level_of_education.png', format='png', dpi=300)
...
def graph4(df):
    ...
    plt.savefig('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-2/result/pie_chart_of_lunch_types.png', format='png', dpi=300)
...
def graph5(df):
    ...
    plt.savefig('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-2/result/scatter_plot_of_reading_vs_writing.png', format='png', dpi=300)


def analysis():
    df = pd.read_csv('D:/Sai Vignesh/Assignments/PDS/PDS ASSIGNMENT 1/task-2/data_clean/clean_data.csv')
    graph1(df)
    graph2(df)
    graph3(df)
    graph4(df)
